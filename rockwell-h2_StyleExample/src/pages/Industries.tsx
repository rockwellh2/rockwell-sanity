  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          {/* Tabs */}
          <div className="flex flex-wrap gap-2 mb-12 border-b border-neutral-200 pb-4">
              ...
              <button
                ...
                className={`px-6 py-3 text-sm font-medium transition-all duration-150 ${
                  activeTab === industry.id
                    ...
                    : 'bg-white border border-neutral-200 text-neutral-500 hover:border-primary-500'
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="feature-card flex items-center justify-center min-h-[400px]">
              <activeIndustry.icon className="w-32 h-32 text-primary-500 opacity-30" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="feature-card text-center">
              ...
              <div className="text-sm text-neutral-500">Fleet reduction possible</div>
            </div>
            <div className="feature-card text-center">
              <div className="text-4xl font-bold text-primary-500 mb-2">$3/kg</div>
              <div className="text-sm text-neutral-500">Production tax credit</div>
            </div>
            <div className="feature-card text-center">
              <div className="text-4xl font-bold text-primary-500 mb-2">30%</div>
              <div className="text-sm text-neutral-500">Investment tax credit</div>
            </div>
            <div className="feature-card text-center">
              <div className="text-4xl font-bold text-primary-500 mb-2">0</div>
              <div className="text-sm text-neutral-500">Emissions</div>
            </div>
          </div>
        </div>
      </section>
