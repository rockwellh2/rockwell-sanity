...
import { Users, Shield, History, ArrowRight, Phone, Award, Wrench, Headphones } from "lucide-react";
...
export default function WhyRockwellPage() {
          ...
          ============================================================ */}
            <section className="relative bg-slate-50 pt-32 pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <SectionHeader
                        subtitle="The Rockwell Lineage"
                        title="Built by Industrial Engineers."
                        description="Rockwell H2 is a family-owned engineering firm with 30 years of industrial deployment experience. We build systems that run, get serviced, and scale with your operation."
                    />
    ...
    {/* ============================================================
          2. THE ROCKWELL DIFFERENCE - 6 DIFFERENTIATORS
          ============================================================ */}
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <DifferentiatorCard
                        ...
                        title="30 Years Industrial Expertise"
                        description="Industrial systems since 1994 — controls, power integration, and harsh-environment deployments. We've seen what breaks and build for decades of uptime."
                    />
                    <DifferentiatorCard
                        icon={<Shield className="text-green-600" />}
                        title="Zero Safety Incidents"
                        description="Safety-first engineering with redundant containment, automated monitoring, and full audit trails across every single deployment."
                    />
                    <DifferentiatorCard
                        icon={<Wrench className="text-orange-500" />}
                        title="Turnkey Installation"
                        description="We install, commission, and train your team. No hand-offs to third parties, no integration gaps, no finger-pointing at go-live."
                    />
                    <DifferentiatorCard
                        icon={<Award className="text-purple-600" />}
                        title="Field Serviceable"
                        description="Designed for real-world maintenance. Local technicians can service components without factory reps — minimizing downtime and service costs."
                    />
                    <DifferentiatorCard
                        icon={<Users className="text-cyan-600" />}
                        title="Family-Owned Values"
                        description="No corporate bureaucracy. Direct access to the engineers who designed your system. We answer our own phones — always."
                    />
                    <DifferentiatorCard
                        icon={<Headphones className="text-slate-600" />}
                        title="Direct Engineering Access"
                        description="When you call, you get an engineer — not a sales rep, not a call center. Real technical conversations from day one."
                    />
                </div>
            </div>
            </section >
    ...
    return (
        <div className="flex gap-6 items-start">
            <div className="flex-shrink-0 w-20 text-right">
                <span className="font-mono font-bold text-emerald-600 text-lg">{year}</span>
            </div>
