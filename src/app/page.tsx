      ...
      <section className="relative min-h-[calc(100vh-80px)] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-display font-bold text-[#111827] mb-6">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link href="/solutions#biomass" className="feature-card group cursor-pointer">
              <div className="w-12 h-12 flex items-center justify-center mb-6">
                <Leaf className="w-8 h-8 text-[#00CC66]" />
              </div>
              <h3 className="text-h3 font-medium text-[#111827] mb-4">
                I have waste/biomass
              </h3>
              <p className="text-[#6B7280] mb-6">
                Convert organic waste into valuable hydrogen fuel and reduce disposal costs.
              </p>
              <span className="inline-flex items-center text-[#00CC66] font-medium group-hover:gap-2 transition-all">
                Learn more <ArrowRight className="w-4 h-4 ml-1" />
              </span>
            </Link>

            <Link href="/solutions#renewables" className="feature-card group cursor-pointer">
              <div className="w-12 h-12 flex items-center justify-center mb-6">
                <Sun className="w-8 h-8 text-[#00CC66]" />
              </div>
              <h3 className="text-h3 font-medium text-[#111827] mb-4">
            ...
            <Link href="/solutions#resilience" className="feature-card group cursor-pointer">
              <div className="w-12 h-12 flex items-center justify-center mb-6">
                <Fuel className="w-8 h-8 text-[#00CC66]" />
              </div>
              <h3 className="text-h3 font-medium text-[#111827] mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="feature-card">
              <Zap className="w-8 h-8 text-[#00CC66] mb-4" />
              <h3 className="text-h3 font-medium text-[#111827] mb-2">Turnkey Solution</h3>
            ...
            <div className="feature-card">
              <Shield className="w-8 h-8 text-[#00CC66] mb-4" />
              <h3 className="text-h3 font-medium text-[#111827] mb-2">Safety First</h3>
              <p className="text-[#6B7280] text-sm">
            ...
            <div className="feature-card">
              ...
              <h3 className="text-h3 font-medium text-[#111827] mb-2">Speed to Deploy</h3>
              <p className="text-[#6B7280] text-sm">
            ...
            <div className="feature-card">
              <Battery className="w-8 h-8 text-[#00CC66] mb-4" />
              <h3 className="text-h3 font-medium text-[#111827] mb-2">Long-Term Storage</h3>
              <p className="text-[#6B7280] text-sm">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-8 border border-[#E5E7EB]">
              <div className="text-5xl font-bold text-[#00CC66] mb-2">225</div>
              <div className="text-sm uppercase tracking-wider text-[#6B7280]">kg H2/day production</div>
            </div>
            <div className="p-8 border border-[#E5E7EB]">
              <div className="text-5xl font-bold text-[#00CC66] mb-2">99.9%</div>
              <div className="text-sm uppercase tracking-wider text-[#6B7280]">System uptime</div>
            </div>
            <div className="p-8 border border-[#E5E7EB]">
              <div className="text-5xl font-bold text-[#00CC66] mb-2">Days</div>
              <div className="text-sm uppercase tracking-wider text-[#6B7280]">Not months to deploy</div>
            </div>
          </div>
        </div>
      </section>
