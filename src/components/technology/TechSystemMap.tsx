        ...
        <section className="py-24 bg-slate-50 border-y border-slate-200 overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-16">
                    <span className="font-mono text-xs font-bold uppercase tracking-widest text-emerald-600 mb-2 block">
                        Architecture
                    </span>
                ...
                <div className="relative flex justify-center items-center min-h-[600px]">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                        <div className="w-48 h-48 bg-slate-950 rounded-full flex flex-col items-center justify-center border-4 border-slate-200 shadow-2xl relative">
                            ...
                            <Database className="text-emerald-500 mb-3" size={40} />
...
function TechCard({ icon: Icon, title, label, desc, specs }: any) {
    return (
        <div className="blueprint-card p-6 flex flex-col items-center text-center bg-white group hover:scale-105 transition-transform duration-300">
            <div className="w-12 h-12 bg-slate-50 rounded-lg flex items-center justify-center mb-4 group-hover:bg-emerald-500/10 transition-colors">
                <Icon size={24} className="text-slate-700 group-hover:text-emerald-600" />
            </div>
            <span className="font-mono text-[10px] uppercase font-bold text-emerald-600 tracking-widest mb-1">{label}</span>
